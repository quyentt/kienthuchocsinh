...
- [ ] **Lớp 8** · Toán Tập 1 (Chương I–V) · `lop-8/toan-bai-tap.html`
- [ ] **Lớp 8** · Toán Tập 2 (khi có PDF)
...
| 8 | Toán (2 tập) | `data/thuvienhoclieu.com-SGK-Toan-8-tu-nam-2026-Tap-1.pdf` (126 tr) — Kết nối tri thức, trang PDF = trang in + 1 (đã kiểm 9 vị trí). **Tập 2 chưa có PDF** | Tập 1 xong 2026-09-25: 5 chương, 25 bài, 51 công thức, 57 cách giải, 45 hình SVG |
...
Phân chia Toán 8 Tập 1 (số trang PDF; ảnh ở `.cache/pages/lop-8/toan-tap-1/`; mục lục p005):
Ch I Đa thức (B1–5) 6–29 · Ch II Hằng đẳng thức đáng nhớ và ứng dụng (B6–9) 30–48 · Ch III Tứ giác (B10–14) 49–76 ·
Ch IV Định lí Thalès (B15–17) 77–90 · Ch V Dữ liệu và biểu đồ (B18–20) 91–111 ·
HĐ trải nghiệm 112–122 · thuật ngữ 123–126. Partial (một chương một file):
`lop-8/_parts/toan8-tap-1a.html` (Ch I) … `toan8-tap-1e.html` (Ch V). Trang `lop-8/toan.html` có tab "Tập 1" và
nút "Tập 2 · sắp có" (disabled); khi có PDF Tập 2 làm như lớp 7.
