...
window.CATALOG = [
  ...
  {
    id: "lop-7", name: "Lớp 7", level: "THCS", status: "ready",
    subjects: [
      { id: "toan", name: "Toán", icon: "∑", color: "#2563eb",
        desc: "Tập 1 · Tập 2", status: "ready", page: "toan.html" },
      { id: "khtn", name: "Khoa học tự nhiên", icon: "🔬", color: "#2b8a3e", desc: "", status: "soon" },
  ...
  {
    id: "lop-8", name: "Lớp 8", level: "THCS", status: "ready",
    subjects: [
      { id: "toan", name: "Toán", icon: "∑", color: "#2563eb",
        desc: "Tập 1 · Tập 2", status: "ready", page: "toan.html" },
      { id: "khtn", name: "Khoa học tự nhiên", icon: "🔬", color: "#2b8a3e", desc: "", status: "soon" },
  ...
  },
  {
    ...
    subjects: [
      ...
      { id: "toan", name: "Toán", icon: "∑", color: "#2563eb",
        desc: "Tập 1 · Tập 2", status: "ready", page: "toan.html" },
      { id: "ngu-van", name: "Ngữ văn", icon: "📖", color: "#b7791f",
        desc: "Tập 1 · Tập 2 · Văn mẫu", status: "ready", page: "ngu-van.html" },
